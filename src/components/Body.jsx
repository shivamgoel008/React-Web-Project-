    ...
    <React.Fragment>
      <div className="body">
        ...
        <label className="flex">
          ...
          <input
            className="w-80 ml-14 mr-4  placeholder:italic placeholder:text-slate-400 block bg-white border border-slate-300 rounded-md py-2 pl-9 pr-3 shadow-md focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm "
            placeholder="Search"
            type="text"
            onChange={(e) => {
          ...
          />
          <button
            className="search-btn rounded-full shadow-lg bg-blue-400 py-1 pb-1 px-4 hover:bg-blue-600 "
            onClick={() => {
        ...
        <div className="filter">
          <button
            className="filter-btn rounded-full bg-blue-400 py-1 pb-1 px-4 hover:bg-blue-600 my-8 mb-8 mx-14"
            onClick={() => {
